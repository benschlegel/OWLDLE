...
export default function Background() {
	...
	return (
		<div className="h-full w-full -z-1 fixed bg-background overflow-hidden ">
			...
			<div className="h-[200vh] w-[150vw] origin-left relative rotate-[-27.4deg] sm:block opacity-20 dark:opacity-15 *:absolute *:skew-x-[-28deg]">
				...
				<div className="top-[35%] left-[24%] w-120 h-[15px] dark:bg-slate-200 bg-slate-300 opacity-50" />
				{/* Top left center on mobile */}
