		...
		<DialogContent>
			...
			<div className="space-y-2.5">
				...
				<div className="flex items-center justify-between">
					<Label htmlFor="filter-dialog-partner" className="text-sm cursor-pointer w-full">
						Partner teams only
					</Label>
					<Switch id="filter-dialog-partner" checked={filters.partnerOnly} onCheckedChange={togglePartner} />
				</div>
